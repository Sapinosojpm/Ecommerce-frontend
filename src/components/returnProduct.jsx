      ...
      {returnStatus === "pending" && (
        <div className="max-w-3xl p-6 mx-auto mb-6 border border-blue-200 rounded-lg bg-blue-50">
          <div className="flex items-start">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-blue-800">Return Request Submitted</h3>
              <div className="mt-2 text-sm text-blue-700">
                <p>Your return request is currently under review by our team.</p>
                <div className="grid grid-cols-2 gap-4 mt-3">
                  <div>
                    <p className="text-xs font-medium text-blue-600">SUBMITTED ON</p>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="p-6 mb-6 bg-white rounded-lg shadow-sm">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-medium text-gray-900">Return Request Details</h3>
                <div className="mt-4 space-y-4">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1">{new Date(returnRequest.createdAt).toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-500">Reason</p>
                      <p className="mt-1">{returnReasons.find(r => r.value === returnRequest.reason)?.label}</p>
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <p className="p-3 mt-1 rounded-md bg-gray-50">{returnRequest.description}</p>
                  </div>
                  ...
                  {returnRequest.adminNotes && (
                    <div className="p-4 border border-blue-100 rounded-lg bg-blue-50">
                      ...
                      <p className="mt-2 text-sm text-blue-700">{returnRequest.adminNotes}</p>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="p-6 bg-white rounded-lg shadow-sm">
            ...
            <div className="flow-root mt-4">
              <ul className="-mb-8">
                {returnRequest.statusHistory.map((historyItem, historyItemIdx) => (
                  <li key={historyItem._id}>
                    <div className="relative pb-8">
                      {historyItemIdx !== returnRequest.statusHistory.length - 1 ? (
                        <span className="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200" aria-hidden="true" />
                      ) : null}
                      <div className="relative flex space-x-3">
                        <div>
                          <span className={`flex items-center justify-center w-8 h-8 rounded-full ring-8 ring-white ${
                        ...
                        <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                          <div>
                            <p className="text-sm text-gray-800 capitalize">
                              ...
                              {historyItem.notes && (
                                <span className="ml-1">- {historyItem.notes}</span>
                              )}
                            </p>
                          </div>
