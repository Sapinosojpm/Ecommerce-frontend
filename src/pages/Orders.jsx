                          ...
                          <div key={item._id} className="flex gap-2">
                            ...
                            {isEligibleForReturn(order) &&
                              (!item.returnStatus ||
                                item.returnStatus === "none") && (
                                <button
                                  className="px-4 py-2 text-xs font-medium text-red-600 transition-colors bg-white border border-red-600 rounded hover:bg-red-50"
                                  onClick={() =>
                                    initiateReturn(order.orderId, item._id)
                                  }
                                >
                                  Return Product
                                </button>
